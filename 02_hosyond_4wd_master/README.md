...
Ένα “όλα-σε-ένα” εκπαιδευτικό project για Arduino 4WD robot car με 3 βασικές λειτουργίες:
...
- TRIG = A0
- ECHO = A1  
⚠️ **ΠΡΟΣΟΧΗ:** Αν TRIG/ECHO είναι ανάποδα → το πρόγραμμα θα βλέπει `999cm` και θα ενεργοποιεί FAIL-SAFE.
...
⚠️ Το **BT RX** θέλει **διαιρέτη τάσης** (5V -> ~3.3V).
...
## 4) TRIM ευθείας (πρακτική διαδικασία)
